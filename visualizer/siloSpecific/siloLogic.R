...
siloMapSubset <- reactive({
  ...
  ssBaseGrowthBase <- siloSpatialSelector(ssBaseData, input$siloZone, ssAttribute, base_year)
  ...
  ssComparisonGrowthBase <- siloSpatialSelector(ssComparisonData, input$siloZone, ssAttribute, base_year)
